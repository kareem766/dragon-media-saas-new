      ...
      <div className="max-w-3xl mx-auto">
        <div className="overflow-hidden rounded-[2rem] border border-blue-100/80 bg-white/90 shadow-[0_25px_70px_rgba(15,47,107,0.08)] backdrop-blur-xl">
          ...
          <div className="px-6 py-7 sm:px-8 space-y-6 text-sm leading-8 text-ink-900/75">
            ...
            <section><h2 className="font-black text-lg text-ink-950">استخدام الخدمة</h2><p className="mt-2">تُستخدم المنصة لإدارة العملاء والمبيعات والتواصل والأتمتة الخاصة بنشاطك التجاري. يُمنع استخدامها لأي غرض غير قانوني أو مسيء أو ينتهك حقوق الغير.</p></section>
            <section><h2 className="font-black text-lg text-ink-950">الحسابات والمسؤولية</h2><p className="mt-2">أنت مسؤول عن الحفاظ على سرية بيانات دخولك، وعن الأنشطة التي تتم عبر حسابك، وعن دقة البيانات التي تقدمها أثناء التسجيل أو استخدام الخدمة.</p></section>
            <section><h2 className="font-black text-lg text-ink-950">الاشتراكات والمدفوعات</h2><p className="mt-2">تبدأ الاستفادة من الميزات المدفوعة وفق حالة الاشتراك والخطة المحددة في حسابك، وبعد استكمال إجراءات الدفع والمراجعة المطلوبة. تفاصيل الأسعار والميزات والحدود تظهر في صفحة الخطط.</p></section>
            <section><h2 className="font-black text-lg text-ink-950">الاسترجاع والإلغاء</h2><p className="mt-2">تخضع طلبات الاسترداد والإلغاء لسياسة الاسترجاع واسترداد الأموال المنشورة على الموقع.</p></section>
            <section><h2 className="font-black text-lg text-ink-950">القنوات المتصلة</h2><p className="mt-2">عند ربط حسابات التواصل الاجتماعي الخاصة بك، فإنك تمنح Dragon Media الصلاحيات اللازمة للميزات التي طلبتها. أنت مسؤول عن امتلاك الصلاحيات المناسبة لإدارة الحسابات والصفحات والقنوات التي تقوم بربطها.</p></section>
            <section><h2 className="font-black text-lg text-ink-950">التعديلات</h2><p className="mt-2">قد يتم تحديث هذه الشروط أو تعديل بعض الميزات والخدمات من وقت لآخر. سيتم نشر النسخة المحدثة على الموقع، وقد يتم إخطار المستخدم بالتغييرات الجوهرية عبر القنوات المتاحة في حسابه.</p></section>

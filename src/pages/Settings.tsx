...
إدارة المنصة
  ...
  <div className="grid gap-4 sm:gap-6 lg:grid-cols-[230px_minmax(0,1fr)]">
    <div className="min-w-0 lg:sticky lg:top-6 lg:self-start">
      <nav
        className="flex max-w-full gap-2 overflow-x-auto pb-1 [-ms-overflow-style:none] [scrollbar-width:none] lg:block lg:space-y-2 lg:overflow-visible [&::-webkit-scrollbar]:hidden"
...
return (
<div
className={flex min-w-0 items-start gap-3 rounded-2xl border px-4 py-3 text-sm leading-6 ${ success ? 'border-emerald-200 bg-emerald-50 text-emerald-800' : 'border-red-200 bg-red-50 text-red-800' }}
role={success ? ‘status’ : ‘alert’}
>
<span
className={mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-xs font-black text-white ${ success ? 'bg-emerald-500' : 'bg-red-500' }}
>
{success ? ‘✓’ : ‘!’}

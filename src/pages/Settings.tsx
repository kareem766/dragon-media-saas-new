...
export default function Settings() {
  ...
  const [integrationsLoading, setIntegrationsLoading] =
    useState(false)
  ...
  const handleMetaConnect = async (
    ...
    try {
      ...
      if (
        ...
        throw new Error(
          'استجابة ربط Meta غير صالحة. لم يتم استلام رابط المصادقة.',
        )
      }
  ...
  if (orgError || !organizationId) {
    return (
      <div
        dir="rtl"
        className="rounded-2xl border border-red-200 bg-red-50 p-5 text-sm font-medium leading-6 text-red-800"
      >
        {orgError ||
    ...
    >
      <div>
        ...
        <p className="mt-1 max-w-2xl text-sm leading-6 text-ink-900/55">
          إدارة بيانات الشركة والإشعارات والتكاملات
          وإعدادات الخدمات المرتبطة بحسابك.
        </p>
      </div>
      ...
      <div className="grid gap-4 sm:gap-6 lg:grid-cols-[230px_minmax(0,1fr)]">
        <div className="min-w-0 lg:sticky lg:top-6 lg:self-start">
          <nav
            className="flex max-w-full gap-2 overflow-x-auto pb-1 lg:block lg:space-y-2 lg:overflow-visible"
        ...
        <main className="min-w-0 overflow-hidden rounded-2xl border border-sand-200 bg-white shadow-sm sm:rounded-3xl">
  ...
  return (
    <section>
      <SectionHeader
        eyebrow="الشركة"
        title="بيانات الشركة"
        description="حدّث بيانات المؤسسة الأساسية التي تظهر داخل حسابك."
      />

      <div className="space-y-5 p-4 sm:space-y-6 sm:p-8">
        <div className="rounded-2xl border border-sand-200 bg-gradient-to-l from-amber-50/70 via-white to-sand-50 p-4 sm:p-5">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
            <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-sand-200 bg-white shadow-sm sm:h-24 sm:w-24">
              {org.logo_url ? (
                <img
                  src={org.logo_url}
                  alt={
                ...
                <div className="flex h-full w-full items-center justify-center bg-ink-950 px-2 text-center text-xs font-bold text-amber-400">
                  شعار الشركة
                </div>
              )}
            </div>
            ...
            <div className="min-w-0 flex-1">
              ...
              <input
                ...
                placeholder="https://..."
                dir="ltr"
                className="mt-3 w-full min-w-0 rounded-xl border border-sand-300 bg-white px-4 py-3 text-left text-sm text-ink-950 outline-none transition placeholder:text-ink-900/30 focus:border-ink-900/30 focus:ring-4 focus:ring-amber-100"
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3 border-t border-sand-100 pt-5 sm:flex-row sm:items-center sm:pt-6">
          <button
            type="button"
            onClick={handleSave}
            disabled={saving}
            className="inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-xl bg-ink-950 px-5 py-3 text-sm font-bold text-white transition hover:bg-ink-900 disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto sm:min-w-40"
          >
            {saving && (
          ...
          <span className="text-xs leading-5 text-ink-900/40">
  ...
  return (
    <section>
      <SectionHeader
        eyebrow="التنبيهات"
        title="الإشعارات"
        description="تحكم في الإشعارات التي تريد استقبالها داخل حسابك."
      />
      ...
      <div className="space-y-4 p-4 sm:p-8">
        {loading ? (
          ...
          <>
            ...
            <div className="border-t border-sand-100 pt-5 sm:pt-6">
              <button
                type="button"
                onClick={onSave}
                disabled={saving}
                className="inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-xl bg-ink-950 px-5 py-3 text-sm font-bold text-white transition hover:bg-ink-900 disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto sm:min-w-44"
              >
                {saving && (
                  <span className="h-4 w-4 animate-spin rounded-full border-2 border-white/30 border-t-white" />
                )}
      ...
      <SectionHeader
        ...
        action={
          <button
            ...
            disabled={loading}
            className="inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-xl border border-sand-300 bg-white px-4 py-2.5 text-xs font-bold text-ink-900 transition hover:bg-sand-50 disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto"
          >
            {loading && (
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs leading-5 text-blue-800/70">
                ربط Meta يتيح إعداد أصول WhatsApp
                Business وFacebook وInstagram الخاصة
                بشركتك من خلال الاتصال الرسمي. بيانات
                الاعتماد الحساسة لا يتم عرضها داخل لوحة
                التحكم.
              </p>
            </div>
          </div>
  ...
  return (
    <section>
      <SectionHeader
        ...
        description="إدارة حالة اتصال WhatsApp Business من خلال Meta."
      />
        ...
        >
          <div className="flex flex-col gap-5">
            <div className="flex min-w-0 items-start gap-3 sm:gap-4">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-ink-950 text-xs font-black text-amber-400 sm:h-14 sm:w-14">
                WA
              </div>
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 text-sm leading-6 text-ink-900/50">
                  سيتم التحكم في الربط والإعدادات
                  المتقدمة من خلال التكامل الرسمي مع Meta.
                </p>
              </div>
            </div>
          ...
          {integration?.error_message && (
            <div
              className="mt-5 break-words rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-sm leading-6 text-red-700"
              role="alert"
            >
              {integration.error_message}
            </div>
  ...
  return (
    <section>
      <SectionHeader
        ...
        description="حالة مساعد RYAN وإعدادات الذكاء الاصطناعي المرتبطة بالحساب."
      />

      <div className="p-4 sm:p-8">
        <div className="rounded-2xl border border-sand-200 bg-gradient-to-l from-amber-50/70 via-white to-sand-50 p-5 sm:rounded-3xl sm:p-6">
          <div className="flex items-start gap-3 sm:gap-4">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-ink-950 text-xs font-black text-amber-400 sm:h-14 sm:w-14 sm:text-sm">
              AI
            </div>
  ...
  return (
    <section>
      <SectionHeader
        eyebrow="Billing"
        title="الفوترة"
        description="إدارة الاشتراك وطلبات الدفع من خلال نظام Billing المركزي."
      />

      <div className="p-4 sm:p-8">
        <div className="rounded-2xl border border-sand-200 bg-sand-50/60 p-5 sm:rounded-3xl sm:p-6">
          ...
          <p className="mt-2 max-w-xl text-sm leading-7 text-ink-900/55">
            يتم التعامل مع الاشتراكات وطلبات الدفع
            ومراجعة المدفوعات من خلال نظام Plans وBilling
            المخصص للمنصة.
          </p>

          <div className="mt-5 rounded-2xl border border-sand-200 bg-white px-4 py-3 text-xs leading-5 text-ink-900/45">
            لا يتم عرض بيانات دفع وهمية أو معلومات مالية
            غير مرتبطة بالحساب.
          </div>
        </div>
      </div>
...
function SectionHeader({
  ...
  return (
    <div className="border-b border-sand-100 bg-sand-50/50 px-4 py-5 sm:px-8 sm:py-6">
...
function NotificationToggle({
  ...
  return (
    <label className="flex cursor-pointer items-start justify-between gap-4 rounded-2xl border border-sand-200 bg-white p-4 transition hover:border-sand-300 hover:bg-sand-50/50">
      <div className="min-w-0">
  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full min-w-0 rounded-xl border border-sand-300 bg-white px-4 py-3 text-sm text-ink-950 outline-none transition placeholder:text-ink-900/30 focus:border-ink-900/30 focus:ring-4 focus:ring-amber-100"
      />
    </div>
  )
}
...
function StatusBadge({
  ...
  return (
    <span
      className={`max-w-full shrink-0 rounded-full px-2.5 py-1 text-[11px] font-bold ${classes}`}
    >
      {label}
    </span>
  )
...
function MessageBox({
  ...
  return (
    <div
      className={`flex min-w-0 items-start gap-3 rounded-2xl border px-4 py-3 text-sm leading-6 ${
        success
...
function InfoRow({
  ...
  return (
    <div>
      ...
      <div
        dir={dir}
        className="mt-1.5 break-words text-sm font-bold text-ink-950"
      >
        {value}
      </div>
    </div>

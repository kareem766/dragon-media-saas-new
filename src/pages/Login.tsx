...
export default function Login() {
  ...
  // During signup Supabase may briefly emit a SIGNED_IN session before AuthContext signs it out.
  // Keep the user on the signup flow instead of redirecting away.

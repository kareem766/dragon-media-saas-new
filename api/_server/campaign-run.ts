      ...
      for (const row of claimedRows as any[]) {
        try {
          ...
          if (channel === 'whatsapp') {
            ...
            await metaPost('/' + encodeURIComponent(pageId) + '/subscribed_apps?subscribed_fields=messages,messaging_postbacks,messaging_optins,messaging_referrals,message_deliveries', token, {})

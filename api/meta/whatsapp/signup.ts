...
export default function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const params = new URLSearchParams({ client_id: appId, redirect_uri: redirectUri, config_id: configId, response_type: 'code', override_default_response_type: 'true', state, extras })
